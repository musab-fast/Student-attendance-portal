...
const StudentTimetable = () => {
    ...
    const fetchTimetable = async () => {
        try {
            setLoading(true);
            const { data } = await axios.get('http://localhost:5000/api/student/timetable', config);
            setTimetable(data);
            setLoading(false);
        } catch (error) {
        ...
        <div className="bg-[#2E2E2E] p-4 rounded-lg border border-[#2E2E2E] hover:border-[#1D4ED8] transition-all duration-300 hover:shadow-lg hover:shadow-[#1D4ED8]/10">
            ...
            <div className="space-y-1 text-xs text-[#D1D5DB]">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span>{entry.teacher?.user_id?.name}</span>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <Layout role="student">
            ...
            <div className="mb-8 animate-fadeInUp">
                ...
                <p className="text-[#D1D5DB]">Your weekly class schedule</p>
            </div>
            ...
            {loading ? (
                ...
                <div className="card-dark p-12 text-center">
                    ...
                    <p className="text-[#4B5563] text-sm mt-2">Your timetable will appear here once courses are scheduled</p>
                </div>
            ) : (
